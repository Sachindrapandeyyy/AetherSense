#!/usr/bin/env python3
"""
aethersense-sensing-server.py — ADR-125 Tier 1+2 iter 2.

A tiny HTTP server that speaks the subset of the AetherSense sensing-server
...
Endpoints (matched against tools/aethersense-mcp/src/tools/*.ts):
...
The source-of-truth file is `/tmp/aethersense-last-feature.json` written
...
FEATURE_FILE = os.environ.get("AETHERSENSE_FEATURE_JSON",
