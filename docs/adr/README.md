...
This folder contains 45 Architecture Decision Records (ADRs) that document every significant technical choice in the AetherSense / WiFi-DensePose project.
...
| [ADR-031](ADR-031-aethersense-sensing-first-rf-mode.md) | AetherSense Sensing-First RF Mode | Proposed |
...
| [ADR-097](ADR-097-adopt-rvcsi-as-aethersense-csi-runtime.md) | Adopt rvCSI as AetherSense's primary CSI runtime (phased adoption) | Proposed |
| [ADR-098](ADR-098-evaluate-midstream-fit.md) | Evaluate `ruvnet/midstream` for AetherSense's CSI / WebSocket / mesh pipeline | Rejected |
| [ADR-099](ADR-099-midstream-introspection-tap.md) | Adopt midstream as AetherSense's real-time introspection + low-latency tap | Proposed |
