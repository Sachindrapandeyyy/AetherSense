...
This document maps out the domain model for the AetherSense Tauri desktop application
...
**Persistence**: The registry is persisted to `~/.aethersense/nodes.db` (SQLite via
