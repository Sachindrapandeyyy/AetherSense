...
| `aethersense_sensing_ui` | Sensing-first RF UI mode | ADR-031 |
...
| `adr031_aethersense` | 031 | 4 | `persistent_field_model`, `coherence_gating` | `aethersense_sensing_ui = true` | None |
