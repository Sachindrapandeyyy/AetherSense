...
import type { AethersenseConfig, EdgeVitalsMessage } from "../src/types.js";
...
describe("aethersense.presence.now handler", () => {
...
describe("aethersense.vitals.get_breathing handler", () => {
  it("soft-fails when sensing-server unreachable", async () => {
...
describe("aethersense.vitals.get_heart_rate handler", () => {
  it("soft-fails when sensing-server unreachable", async () => {
...
describe("aethersense.vitals.get_all handler", () => {
  it("soft-fails when sensing-server unreachable", async () => {
