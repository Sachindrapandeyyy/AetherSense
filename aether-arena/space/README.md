...
- **Project-agnostic** — any team, framework, or modality enters; AetherSense donated the seed
...
Spec: [ADR-149](https://github.com/ruvnet/AetherSense/blob/main/docs/adr/ADR-149-public-community-leaderboard-huggingface.md).
Source + open scorer: https://github.com/ruvnet/AetherSense/tree/main/aether-arena
