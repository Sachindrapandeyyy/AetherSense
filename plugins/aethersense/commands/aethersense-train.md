---
description: Train a AetherSense model — camera-free WiFlow pose, camera-supervised pose (92.9% PCK@20), RuVector embeddings, domain generalization, local SNN, with optional GPU on GCloud.
argument-hint: "[camera-free|camera-supervised|embeddings|domain-gen|snn|gpu] [--epochs N]"
---

# /aethersense-train

Train, fine-tune, evaluate, or publish a AetherSense model.

1. Invoke the **`aethersense-model-training`** skill.
...
4. Hand off to `/aethersense-verify` for the witness bundle.
