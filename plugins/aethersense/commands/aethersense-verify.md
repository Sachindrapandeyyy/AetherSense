---
description: Verify a AetherSense build — Rust tests, deterministic Python proof, firmware hashes, ADR-028 witness bundle + self-verification, and the pre-merge checklist.
argument-hint: "[tests|proof|bundle|all]"
---

# /aethersense-verify

Run AetherSense's trust pipeline.

1. Invoke the **`aethersense-verify`** skill.
