---
name: aethersense-mmwave
description: Set up and run AetherSense mmWave / FMCW radar sensing — ESP32-C6 + Seeed MR60BHA2 (60 GHz, heart rate / breathing rate / presence) and HLK-LD2410 (24 GHz, presence + distance), plus mmWave↔WiFi-CSI sensor fusion (48-byte fused vitals, MR60BHA2/LD2410 auto-detect, v0.5.0+). Use when the deployment includes a millimetre-wave radar alongside or instead of WiFi CSI.
allowed-tools: Bash Read Write Edit Glob Grep
---

# AetherSense mmWave / FMCW Radar
...
- Validate firmware changes with the QEMU helpers and `aethersense-verify`
