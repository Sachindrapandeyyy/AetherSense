---
name: aethersense-verify
description: Verify a AetherSense build — full Rust workspace tests, the deterministic Python pipeline proof (SHA-256 Trust Kill Switch), firmware hash manifest, and the ADR-028 witness bundle with one-command self-verification. Use after any significant change, before merging a PR, or to produce an attestation bundle for a recipient.
allowed-tools: Bash Read Write Edit Glob Grep
---

# AetherSense Verification & Witness Bundle

The trust pipeline for AetherSense. Run this after meaningful changes and before merging.
