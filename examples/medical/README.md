...
### How This Connects to AetherSense

This example is part of the [AetherSense](https://github.com/ruvnet/AetherSense) ambient intelligence platform. When combined with WiFi CSI sensing:
